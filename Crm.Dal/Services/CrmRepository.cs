...
namespace Crm.Dal.Services
{
    public class CrmRepository : BaseData, ICrmRepository
    {
                    ...
                    if (reader.HasRows)
                    {
                        while (reader.Read())
                        {
                            ...
                            customer = new Customer()
                            {
                                ...
                                PostCode = reader["Country"].ToString()
                            };
        ...
        public bool UpdateCustomerCall(CustomerCall customerCall)
        {
            try
            {
                using (this.Initialize())
                {
                    ...
                    cmd.Parameters.Add(new SqlParameter("@CustomerNo", customerCall.CustomerNo));
        ...
        public Guid InsertCustomerCall(CustomerCall customerCall)
        {
            Guid id = new Guid();
            try
            {
